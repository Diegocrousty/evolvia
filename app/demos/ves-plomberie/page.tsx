...
export default async function VesPlomberie() {
  const [heroImage, imgDepannage, imgRenovation, imgFuite, imgChauffage, imgArtisan] =
    await Promise.all([
      ...
      getUnsplashImage('water leak detection pipe inspection', {
        width: 600,
        height: 400,
        index: 2,
      }),
  ...
  const serviceImages = [
    ...
    { src: imgFuite.src, alt: imgFuite.alt },
    { src: imgChauffage.src, alt: imgChauffage.alt },
  ]
