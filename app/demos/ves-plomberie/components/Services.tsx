...
const services = [
  ...
  },
  {
    ...
    description: 'Douche à l\'italienne, remplacement baignoire, carrelage. Partenaire Aubade — accès showrooms Limonest et Villeurbanne.',
    price: 'Devis sur mesure',
  },
  {
    title: 'Recherche de fuite',
    description: 'Détection et réparation de fuite, y compris sous dalle. Diagnostic précis, réparation durable.',
    price: 'Devis gratuit',
  },
  {
    title: 'Chauffage & chaudière',
    description: 'Entretien, dépannage et remplacement de chaudière. Chauffage central, plancher chauffant.',
    price: 'Devis gratuit',
  },
]
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Plomberie, chauffage, rénovation salle de bain Lyon — devis gratuit, intervention rapide
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12" style={{ gap: '24px' }}>
          ...
          {/* 3 smaller cards — stacked, spans 5 cols */}
              ...
              return (
                ...
                >
                  <div className="flex flex-col sm:flex-row md:flex-col">
                    {img && (
                      <div className="relative overflow-hidden flex-shrink-0" style={{ height: '96px' }}>
                        <Image
                          src={img.src}
                          alt={img.alt}
                          fill
        ...
        >
          ...
          <div className="flex flex-wrap" style={{ gap: '12px' }}>
            {['Chauffe-eau & ballon', 'Mécanisme WC', 'Installation tuyauterie', 'Robinetterie', 'Détartrage'].map((s) => (
              <a
                key={s}
                href="#devis"
